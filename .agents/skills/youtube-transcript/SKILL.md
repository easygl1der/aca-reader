...
```bash
python3 ~/.Codex/skills/youtube-transcript/youtube_summary.py "YOUTUBE_URL"
```
...
```bash
# Process a video
python3 ~/.Codex/skills/youtube-transcript/youtube_summary.py "https://www.youtube.com/watch?v=dQw4w9WgXcQ"

# Or just the video ID
python3 ~/.Codex/skills/youtube-transcript/youtube_summary.py "dQw4w9WgXcQ"
```
