...
- `YOUTUBE_API_KEY` — Set in environment or `~/.Codex/.env`. Get from [Google Cloud Console](https://console.cloud.google.com/apis/credentials)
...
- Set `YOUTUBE_API_KEY` in your shell, `~/.Codex/.env`, or local `.env`
