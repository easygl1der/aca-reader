...
% 覆盖 roboto 字体（不支持中文），使用系统默认英文
\usepackage[sfdefault, light]{roboto}

% 重定义 answer 相关环境：移除 \defaultfont（会破坏 xeCJK 中文）
\renewenvironment{answer}{
  \begin{tcolorbox}[%
    ...
    \CJK_addfontfeature{RawFeature=+ protrusion}%
  }{
  \end{tcolorbox}
}

\renewenvironment{subanswer}{
  \begin{tcolorbox}[%
...
\newcommand{\assignmentAuthorName}{Yue Yihua}
\newcommand{\studentID}{}
