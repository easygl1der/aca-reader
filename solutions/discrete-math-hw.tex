...
\begin{question}{3-7(1)}
  ...
  \begin{subq}{(d) 若 $R_1$ 和 $R_2$ 是传递的，则 $R_1 \circ R_2$ 也是传递的。}
    \begin{Answer}
      ...
      \begin{info}[补充证明：]
        由 $x(R_1 \circ R_2)y$ 和 $y(R_1 \circ R_2)z$，存在 $u, v$ 使 $xR_1u, uR_2y$ 及 $yR_1v, vR_2z$。由 $R_2$ 传递性：$uR_2y$ 和 $yR_1v$ 不能直接合成，但由 $R_1$ 传递性：$xR_1u$ 和 $uR_1v$（需先得 $uR_1v$）。由 $R_1 \circ R_2$ 的定义，$uR_2y$ 和 $yR_1v$ 合成为 $u(R_2 \circ R_1)v$，再由 $R_1$ 传递性得 $xR_1v$，最后 $x(R_1 \circ R_2)z$。
      \end{info}
    \end{Answer}
  \end{subq}
\end{question}
