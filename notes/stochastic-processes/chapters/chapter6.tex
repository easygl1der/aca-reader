...
Then, by Jensen's inequality, $M_k^n, k = 0, \ldots, 2^n$ is a non-negative square integrable submartingale with respect to the filtration $\mathcal{F}_k^n = \mathcal{F}_{\frac{k+1}{2^n}}$, so by \cref{thm:doob-maximal-inequality-discrete}
\[
