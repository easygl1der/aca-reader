...
\par\Notes{方差分析推导见附录 \cref{sec:appendix-5-7}。}
...
\par\Notes{渐近正态性推导见附录 \cref{sec:appendix-5-13}。}
...
\par\Notes{主要定理的完整证明见附录 \crefrange{sec:appendix-5-2-balance}{sec:appendix-5-14}。}
