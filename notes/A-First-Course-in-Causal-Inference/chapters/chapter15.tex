...
\section{习题}\label{sec:15-homework}

\begin{HomeworkProblem}[Linear expansions of the bias-corrected estimators]\label{exr:15-1}
...
\begin{HomeworkProblem}[Doubly robust form of the bias-corrected matching estimator for $\tau$]\label{exr:15-2}
...
\begin{HomeworkProblem}[Doubly robust form of the bias-corrected matching estimator for $\tau_\textsc{t}$]\label{exr:15-3}
...
\begin{HomeworkProblem}[Revisit Example \ref{eg::chan-bmi-ATE}]\label{exr:15-4}
...
\begin{HomeworkProblem}[Revisit Chapter \ref{sec::matching-application}]\label{exr:15-5}
...
\begin{HomeworkProblem}[Data re-analyses]\label{exr:15-6}
...
\begin{HomeworkProblem}[Recommended reading]\label{exr:15-7}
