...
\citet{li2017general} 进一步证明了基于有限总体 CLT 的 $\hat{\tau}$ 的渐近正态性：
...
回忆在 \cref{def:cre} 中定义的完全随机实验。假设我们只关心 Bipartite RE（见 Definition 4.1）。在这种设定下，推导平均因果效应的方差公式，并比较其与 CRE 中方差的差异。
\end{Exercise}

\begin{Exercise}{\ref{ex:4.8} 推荐阅读}\label{ex:4.8}
\begingroup
\parskip=0pt
\textbf{推荐阅读}：\cite{ding2017interpretation} 重新审视了因果推断中的一些经典问题。\cite{imbens2015causal} 是关于因果推断的权威综述。
