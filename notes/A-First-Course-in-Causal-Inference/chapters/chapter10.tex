...
\section{习题}\label{sec:10-homework}

\begin{HomeworkProblem}[A simple identity]\label{exr:10-1}
...
\begin{HomeworkProblem}[Nonparametric identification of other causal effects]\label{exr:10-2}
...
\begin{HomeworkProblem}[Outcome imputation estimator in the fully interacted logistic model]\label{exr:10-3}
...
\begin{HomeworkProblem}[Data analysis: stratification and regression]\label{exr:10-4}
...
\begin{HomeworkProblem}[Ignorability versus strong ignorability]\label{exr:10-5}
...
\begin{HomeworkProblem}[Recommended reading]\label{exr:10-6}
