...
\begin{figure}[ht]
\centering
\safeincludegraphics[width = 0.7\textwidth]{figures/crossworld.pdf}
...
\section{习题}\label{sec:27-homework}

\begin{HomeworkProblem}[\citet{Robins::1992}'s clarification of the units based on nested potential outcomes]\label{exr:27-1}
...
\begin{HomeworkProblem}[Sequential randomization and joint randomization]\label{exr:27-2}
...
\begin{HomeworkProblem}[Verifying the assumptions for mediation analysis]\label{exr:27-3}
...
\begin{HomeworkProblem}[Another set of assumptions for the mediation formula]\label{exr:27-4}
...
\begin{HomeworkProblem}[Difference method and product method are identical]\label{exr:27-5}
...
\begin{HomeworkProblem}[Natural indirect effect with a binary mediator]\label{exr:27-6}
...
\begin{HomeworkProblem}[With treatment-outcome interaction on the outcome]\label{exr:27-7}
...
\begin{HomeworkProblem}[Mediation analysis with continuous mediator and binary outcome]\label{exr:27-8}
...
\begin{HomeworkProblem}[Mediation analysis with binary mediator and continuous outcome]\label{exr:27-9}
...
\begin{HomeworkProblem}[Mediation analysis with binary mediator and outcome]\label{exr:27-10}
...
\begin{HomeworkProblem}[Modify the definitions to drop the cross-world independence]\label{exr:27-11}
...
\begin{HomeworkProblem}[Connections between principal stratification and mediation analysis]\label{exr:27-12}
