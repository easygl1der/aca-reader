...
\begin{HomeworkProblem}[A technical lemma for the proof of Theorem \ref{thm::bounding-factor}]\label{exr:17-1}
...
\begin{HomeworkProblem}[Technical assumption for Theorem \ref{thm::bounding-factor}]\label{exr:17-2}
...
\begin{HomeworkProblem}[Lemma \ref{lemma::betaw1w2}]\label{exr:17-3}

Prove Lemma \ref{lemma::betaw1w2}.

\end{HomeworkProblem}

\begin{HomeworkProblem}[\citet{Schlesselman::1978}'s formula]\label{exr:17-4}
...
\begin{HomeworkProblem}[E-value after logistic regression: data analysis]\label{exr:17-5}
...
\begin{HomeworkProblem}[Cornfield-type inequalities for the risk difference]\label{exr:17-6}
...
\begin{HomeworkProblem}[Recommended reading]\label{exr:17-7}
