...
\section{习题}\label{sec:11-homework}

\begin{HomeworkProblem}[Another version of Theorem \ref{thm::pscore-dimreduction}]\label{exr:11-1}
 Prove that
\begin{equation}
...
\begin{HomeworkProblem}[Another version of Theorem \ref{thm::pscore-dimreduction}]\label{exr:11-2}
...
\begin{HomeworkProblem}[More results on the IPW estimators]\label{exr:11-3}
...
\begin{HomeworkProblem}[Re-analysis of \citet{Rosenbaum::1983JRSSB}]\label{exr:11-4}
...
\begin{HomeworkProblem}[Balancing score and propensity score: more theoretical results]\label{exr:11-5}
...
\begin{HomeworkProblem}[Some basics of subgroup effects]\label{exr:11-6}
...
\begin{HomeworkProblem}[Recommended reading]\label{exr:11-7}
