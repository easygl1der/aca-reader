...
\tag{16.4}
\label{eq:16-unconfoundedness-formal}
\]
...
\begin{HomeworkProblem}[More details for the formula of Z-bias]\label{exr:16-1}
Verify \eqref{eq::zbias-result}.


\end{HomeworkProblem}

\begin{HomeworkProblem}[Cochran's formula or the omitted variable bias formula]\label{exr:16-2}
...
\begin{HomeworkProblem}[Recommended reading]\label{exr:16-3}
