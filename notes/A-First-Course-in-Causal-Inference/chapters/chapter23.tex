...
\section{习题}\label{sec:23-homework}

\begin{HomeworkProblem}[More algebra for TSLS in Section \ref{sec::sec::iv-over-identify}]\label{exr:23-1}
...
\begin{HomeworkProblem}[Equivalence between TSLS and ILS]\label{exr:23-2}
...
\begin{HomeworkProblem}[Control function in the linear instrumental variable model]\label{exr:23-3}
...
\begin{HomeworkProblem}[Data analysis: \citet{efron1991compliance}]\label{exr:23-4}
...
\begin{HomeworkProblem}[Recommended reading]\label{exr:23-5}
