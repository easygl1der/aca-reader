...
\section{习题}\label{sec:9-homework}

\begin{HomeworkProblem}[OLS decomposition of the observed outcome under the CRE]\label{exr:9-1}
...
\begin{HomeworkProblem}[Variance estimation of \citet{lin2013}'s estimator under the super population framework]\label{exr:9-2}
...
\begin{HomeworkProblem}[Recommended reading]\label{exr:9-3}
