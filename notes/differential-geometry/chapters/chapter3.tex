...
Let $S$ be the sphere of radius $R$. Show that the normal curvature at any point $p \in S$ in any direction is $\kappa_n = -1/R$. (Hint: use the fact that $S_p = -I/R$.)
\end{exercise}

\begin{exercise}{3-3, 2}
Consider the cylinder $x^2 + y^2 = R^2$. Show that $\kappa_n = 0$ in the direction of the axis and $\kappa_n = 1/R$ in the direction perpendicular to the axis. Use Meusnier's theorem to verify this.
\end{exercise}

\begin{exercise}{3-3, 3}
Show that the normal curvature of a surface $z = f(x,y)$ in the direction making angle $\theta$ with the $x$-axis is
\[
...
\begin{exercise}{3-4, 1* — do Carmo, Exercise 3-3, 5d}
Consider Enneper's surface $\mathbf{x}(u,v) = (u - \frac{u^3}{3} + uv^2, v - \frac{v^3}{3} + vu^2, u^2 - v^2)$. Show that the lines of curvature are the coordinate curves.
\end{exercise}

\begin{exercise}{3-4, 2 — do Carmo, Exercise 3-3, 11}
Consider the monkey saddle $z = x^3 - 3xy^2$. Construct the Dupin indicatrix at $p=(0,0,0)$ and describe its geometric meaning.
\end{exercise}

\begin{exercise}{3-4, 3* — do Carmo, Exercise 3-3, 4}
