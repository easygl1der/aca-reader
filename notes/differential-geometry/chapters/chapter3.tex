...
\begin{exercise}{3-3, 7* — do Carmo, Exercise 3-3, 7 (Surfaces of Revolution with Constant Curvature)}
Surfaces of Revolution with Constant Curvature. Prove for surfaces of revolution with constant $K$: (a) $\varphi'' + K\varphi = 0$, (b) for $K=1$: $\varphi(v) = C\cos v$, (c) for $K=-1$: three types of solutions, (d) type 3 is the pseudosphere, (e) only right circular cylinder, cone, and plane have $K \equiv 0$.
\end{exercise}
