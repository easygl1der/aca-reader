...
\begin{Remark}
本章内容主要基于 \cite{billey1999}（Billey 1999）和 \cite{FominGelfandPostnikov1997}（Fomin-Gelfand-Postnikov 1997）。关于 bumpless pipe dreams，见 \cite{FGL2025}（Fan-Guo-Xiong 2025）。关于仿射 Schubert 演算，见 Postnikov 的综述文章 \cite{FominGelfandPostnikov1997}。
\end{Remark}
