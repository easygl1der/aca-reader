...
Kirillovov 和 Maeno 在 1996 年的工作中引入了\textbf{量子双重 Schubert 多项式} $\widetilde{\mathfrak{S}}_w(\mathbf{x}; \mathbf{y}; \mathbf{q})$，这是旗流形等变量量子上同调类的 Lascoux-Schützenberger 型代表元。本文介绍这一工作的核心内容。
