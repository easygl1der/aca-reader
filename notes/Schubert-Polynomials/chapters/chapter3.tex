...
\[
\langle \widetilde{\mathfrak{S}}_v(\mathbf{x}; \mathbf{y}), \widetilde{\mathfrak{S}}_w(\mathbf{x}; \mathbf{z}) \rangle_Q^{(x)} = \sum_{u \in S_n} \partial_{vw_0}^{(y)} \mathfrak{S}_u(y) \cdot \partial_{ww_0}^{(z)} \mathfrak{S}_{w_0u}(z).
