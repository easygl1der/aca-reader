...
在 $S_3$ 中验证\cref{conj:Samuel}：取 $u = 132$，$v = 213$。计算
$$\mathfrak{S}_{132}(\mathbf{x};\mathbf{y}) \cdot \mathfrak{S}_{213}(\mathbf{x};\mathbf{t}) = (x_2 - y_2)(x_1 - t_1)$$

展开得 $x_1x_2 - x_1y_2 - x_2t_1 + y_2t_1$，可见所有系数均为非负的 $t_i - y_j$ 型单项式，符合\cref{conj:Samuel} 的正性预测。
\end{Example}
