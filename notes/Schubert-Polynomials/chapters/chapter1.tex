...
其中 Grassmannian 置换（如 $132, 231$）的 Schubert 多项式是单项式 $x_1^{c_1} x_2^{c_2}$；非 Grassmannian 置换（如 $213, 312$）则产生对称多项式
...
设 $X$ 是光滑复流形，$\beta \in H_2(X, \mathbb{Z})$ 为曲线类. 量子上同调环 $QH^*(X)$ 的乘法 $\star$ 定义为
\begin{equation}
