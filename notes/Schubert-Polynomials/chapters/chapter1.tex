...
&= x_1^2x_2 - x_1 x_2t_1 - x_1^2y_2 + x_1y_2t_1 \label{eq:u132-v213-expand3} \\
...
$$\mathfrak{S}_{231}(\mathbf{x}; \mathbf{y}) = x_1 x_2 - x_1y_3 - x_2y_3 + y_2y_3$$
...
&= (x_1 x_2 - x_1y_3 - x_2y_3 + y_2y_3)(x_1 - t_3) \label{eq:u231-v312-expand1} \\
&= x_1^2x_2 - x_1 x_2t_3 - x_1^2y_3 + x_1y_3t_3 \label{eq:u231-v312-expand2} \\
&\quad - x_1 x_2y_3 + x_2y_3t_3 + x_1y_2y_3 - y_2y_3t_3 \label{eq:u231-v312-full}
\end{align}
...
\begin{align*}
-x_1 x_2t_3 &= -x_1 x_2[(t_3 - y_3) + y_3] = -x_1 x_2(t_3 - y_3) - x_1 x_2y_3 \\
...
将所有含 $(t_3 - y_3)$ 的项提出：
$$[-x_1 x_2 + x_1y_3 + x_2y_3 - y_2y_3] \cdot (t_3 - y_3)$$
...
查表得：
$$\mathfrak{S}_{231}(\mathbf{x}; \mathbf{y}) = x_1 x_2 - x_1y_3 - x_2y_3 + y_2y_3, \quad \mathfrak{S}_{132}(\mathbf{x}; \mathbf{t}) = x_2 - t_2$$
令 $\mathbf{y} = \mathbf{t} = 0$ 得：
...
$$\mathfrak{S}_{123}(\mathbf{x}) = 1, \quad \mathfrak{S}_{231}(\mathbf{x}) = x_1 x_2, \quad \mathfrak{S}_{321}(\mathbf{x}) = x_1^2x_2$$
...
&= (x_1 x_2 - x_1y_3 - x_2y_3 + y_2y_3)(x_2 - t_2) \\
&= x_1 x_2^2 - x_1 x_2t_2 - x_1y_3x_2 + x_1y_3t_2
\end{align*}}
