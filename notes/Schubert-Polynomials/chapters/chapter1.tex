...
根据 Humphreys \cite[Section 28]{humphreys1975}\footnote{问：Humphreys Section 28 的 Bruhat Decomposition 说了什么？见附录 \cref{sec:HumphreysSection28}。}，作为簇，$N^-(w)$ 同构于 Schubert 胞腔 $B^-wB/B \cong \mathbb{C}^{\ell(w_0) - \ell(w)}$，通过 $x \mapsto xwB/B$。特别地，$N^-(w)$ 是连通的。
