...
最长置换 $w_0 = 321$：由初始条件，
$$\mathfrak{S}_{321}(\mathbf{x}) = x_1^{\binom{3}{2}} = x_1^2 x_2$$
...
验证：从组合意义上，$\mathfrak{S}_{213}$ 只有一个 descent（在位置 1），其首项是 $x_1$，而修正项恰好消除所有涉及 $y_2$ 在负号位置的项，最终只剩 $x_1 - y_2$。
...
{\small
\begin{align*}
\mathfrak{S}_{231} \cdot \mathfrak{S}_{132}
...
&= \sum_{w \in S_n} c^w_{u,v}(\mathbf{y}, \mathbf{t})
\end{align*}}
