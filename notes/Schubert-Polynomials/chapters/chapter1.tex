...
展开整理：
\begin{align*}
\mathfrak{S}_{21}(\mathbf{x}; \mathbf{y}) &= -x_1 x_2 + x_1 y_1 + x_2 y_2 - y_1 y_2 + x_1^2 x_2 - x_1^2 y_1 - x_1 x_2 y_2 + x_1 y_1 y_2 \\
...
该条件被称为 \textbf{descents 条件}，它包含了原始的 Grassmannian 情形作为特例.\footnote{问：Refined Graham Positivity 和原始 Graham Positivity 有什么关系？见附录 \cref{sec:RefinedVsOriginalGraham}。}
