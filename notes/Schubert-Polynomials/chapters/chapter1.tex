...
\textbf{具体例子}：取 $u = 21$（一个 Grassmannian 排列，对应 Grassmannian $\mathbb{G}(1,2)$）和 $v = 132$，有
$$\mathfrak{S}_{21}(\mathbf{x};\mathbf{y}) = x_1, \quad \mathfrak{S}_{132}(\mathbf{x};\mathbf{t}) = x_2^2$$
两者相乘得
$$\mathfrak{S}_{21}(\mathbf{x};\mathbf{y}) \cdot \mathfrak{S}_{132}(\mathbf{x};\mathbf{t}) = x_1 x_2^2$$
