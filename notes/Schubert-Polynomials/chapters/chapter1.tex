...
第三步：将每项写成 $t_j - y_i$ 的形式
\begin{itemize}
\item $x_1x_2$：已是 $\mathfrak{S}_{231}(\mathbf{x}; \mathbf{t})$ 的首项
\item $-x_1t_2 = -x_1(t_2 - y_2) - x_1y_2$：含 $-(t_2 - y_2)$ 因子
\item $-y_2x_2 = -y_2(x_2 - t_2) - y_2t_2$：含 $-y_2$ 因子
\item $y_2t_2 = y_2(t_2 - y_2) + y_2^2$：含 $(t_2 - y_2)$ 因子
\end{itemize}

合并后，每项系数都是 $t_j - y_i$ 的非负整数系数多项式，验证了 \cref{def:GrahamPositivity}。
\end{Example}
...
\textbf{Samuel 猜想反例：$S_4$ 中的非 Grassmannian 验证}：
