...
$$\partial_{w/w_0/w}(\mathfrak{S}_{w_0}(\mathbf{x})) = \partial_{w/v}(\mathfrak{S}_{w_0}(\mathbf{x}))$$

由于 $\mathfrak{S}_{w_0}(\mathbf{x}) = x_1^{n-1} x_2^{n-2} \cdots x_{n-1}$ 是某个特定的单项式，我们可以利用 Billey 公式的展开来计算.
