...
计算乘积
\begin{align*}
&\mathfrak{S}_{132}(\mathbf{x}; \mathbf{y}) \cdot \mathfrak{S}_{213}(\mathbf{x}; \mathbf{t}) \\
&= (x_1 - y_2)(x_2 - y_2)(x_1 - t_1) \\
&= (x_1x_2 - x_1y_2 - x_2y_2 + y_2^2)(x_1 - t_1) \\
&= x_1^2x_2 - x_1x_2t_1 - x_1^2y_2 + x_1y_2t_1 \\
&\quad - x_1x_2y_2 + x_2y_2t_1 + x_1y_2^2 - y_2^2t_1 \tag{展开}
\end{align*}

利用 $t_1 = (t_1 - y_1) + y_1$ 将含 $t_1$ 的项拆分，可验证所有系数都是 $t_j - y_i$ 的非负整数系数多项式。\footnote{完整推导见附录 \cref{sec:GrahamPositivity-full-calculation}。}
