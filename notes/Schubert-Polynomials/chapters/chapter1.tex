...
\begin{align*}
S_{21}(x; y)
&= \sum_{u \leq 21} (-1)^{\ell(21)-\ell(u)} \mathfrak{S}_u(x) \cdot \prod_{i=1}^{2}(x_i - y_{21(i)}) \\
&= (-1)^{1-0} \mathfrak{S}_{12}(x) \cdot (x_1 - y_2)(x_2 - y_1) \\
&\quad + (-1)^{1-1} \mathfrak{S}_{21}(x) \cdot (x_1 - y_1)(x_2 - y_2)
\end{align*}}
