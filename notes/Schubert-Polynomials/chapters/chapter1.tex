...
\node (Samuel) [rectangle, draw, right of=Graham, node distance=4cm] {$u, v$ 任意排列\\ Samuel 猜想};
\node (Kirillov) [rectangle, draw, below of=Samuel, node distance=2.5cm] {$\mathbf{y} = \mathbf{t} = 0$\\ Kirillov 猜想};
