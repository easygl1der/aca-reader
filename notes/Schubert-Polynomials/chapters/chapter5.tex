...
\begin{Proof}
The proof follows the strategy of Gao--Xiong \cite[Section 2]{GX2025}（详见\cref{sec:GX2025-Section2}）, which extends Graham's positivity framework \cite{Gr}\footnote{详见\cref{def:GrahamPositivity}（\cite[Section 2.2]{Gr}）} to the double Schubert setting.
