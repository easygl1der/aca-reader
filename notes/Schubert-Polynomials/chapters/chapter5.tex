...
A striking application of \cref{th:ClassicalDoublePositivity} is the resolution of a conjecture of Kirillov concerning skew divided difference operators.
...
\]
Setting $\mathbf{y} = \mathbf{0}$ in \cref{th:ClassicalDoublePositivity}, we obtain:
\[
...
The proof of \cref{th:ClassicalDoublePositivity} relies on a refined version of Graham's positivity theorem, which we now state in full.
