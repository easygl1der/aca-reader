...
\addcontentsline{toc}{chapter}{Appendix: Positivity in Equivariant Quantum Schubert Calculus}
...
\item \textbf{主定理}（Theorem \cref{th:EQCPositivity}）：EQLR 系数 $c_{u,v}^{w,d}$ 是关于负根 $x_i$ 的非负整数系数多项式；
...
证明的核心思想是将 EQLR 系数的计算归约到 Graham 的经典 positivity 定理（Theorem \cref{th:GrahamPositivity}）。
