...
其中 $\langle \cdot, \cdot \rangle_T$ 是 $H_T^*(X)$ 上的等变 Poincaré pairing\indexfootnote{问：等变 Poincaré pairing $\langle \cdot, \cdot \rangle_T$ 的具体定义是什么？它与普通 Poincaré pairing 有什么关系？为什么 Schubert 类的配对是 Kronecker delta？见附录 \cref{sec:qa-equivariant-poincare-pairing}。}
