...
等变量子上同调（equivariant cohomology） & $c_{u,v}^w \in \mathbb{Z}[x_i]$ & 非负系数多项式 \\
等变量子上同调中的量子 Schubert 演算（equivariant quantum cohomology） & $c_{u,v}^{w,d} \in \mathbb{Z}[x_i]$ & 非负系数多项式
\end{tabular}
\end{center}
