...
\begin{exercise}{\ref{exr:4.2.1} Motor Lifetime Confidence Interval}\label{exr:4.2.1}
...
\begin{exercise}{\ref{exr:4.2.2} Gamma Distribution Inference}\label{exr:4.2.2}
...
\begin{exercise}{\ref{exr:4.2.4} Baseball Weight Difference}\label{exr:4.2.4}
...
\begin{exercise}{\ref{exr:4.2.5} Left-handed Baseball Players}\label{exr:4.2.5}
...
\begin{exercise}{\ref{exr:4.2.6} Sample Size for CI Length}\label{exr:4.2.6}
...
\begin{exercise}{\ref{exr:4.2.7} CI from Sample Data}\label{exr:4.2.7}
...
\begin{exercise}{\ref{exr:4.2.8} Sample Size for Half-length}\label{exr:4.2.8}
...
\begin{exercise}{\ref{exr:4.2.9} Normal CI Length Comparison}\label{exr:4.2.9}
...
\begin{exercise}{\ref{exr:4.2.21} Prediction Interval}\label{exr:4.2.21}
