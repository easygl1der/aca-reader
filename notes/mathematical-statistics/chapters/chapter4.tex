...
\begin{exercise}{\ref{exr:4.1.12} Normal Confidence Intervals}\label{exr:4.1.12}
...
\begin{exercise}{\ref{exr:4.2.1} Motor Lifetime – Hogg 4.2.2}\label{exr:4.2.1}
...
\begin{exercise}{\ref{exr:4.2.2} Gamma Distribution – Hogg 4.2.3}\label{exr:4.2.2}
...
\begin{exercise}{\ref{exr:4.2.4} Baseball Weight – Hogg 4.2.4}\label{exr:4.2.4}
...
\begin{exercise}{\ref{exr:4.2.5} Left-handed Players – Hogg 4.2.5}\label{exr:4.2.5}
...
\begin{exercise}{\ref{exr:4.2.6} Sample Size (σ²=9) – Hogg 4.2.6}\label{exr:4.2.6}
...
\begin{exercise}{\ref{exr:4.2.7} CI from Data – Hogg 4.2.7}\label{exr:4.2.7}
...
\begin{exercise}{\ref{exr:4.2.8} Sample Size (σ²=10) – Hogg 4.2.8}\label{exr:4.2.8}
...
\begin{exercise}{\ref{exr:4.2.9} Normal CI Length – Hogg 4.2.9}\label{exr:4.2.9}
...
\begin{exercise}{\ref{exr:4.2.21} Prediction Interval – Hogg 4.2.11}\label{exr:4.2.21}
...
\begin{exercise}{\ref{exr:4.2.22} Monte Carlo CI – Hogg 4.2.11}\label{exr:4.2.22}
...
\begin{exercise}{\ref{exr:4.2.23} Invariance of CI – Hogg 4.2.12}\label{exr:4.2.23}
In Exercise 4.2.11, show that setting $\mu=0$ and $\sigma=1$ is without loss of generality.
\end{exercise}

\begin{exercise}{\ref{exr:4.2.24} Empirical Confidence Level – Hogg 4.2.13}\label{exr:4.2.24}
...
\begin{exercise}{\ref{exr:4.2.25} Gamma CI via CLT – Hogg 4.2.14}\label{exr:4.2.25}
...
\begin{exercise}{\ref{exr:4.2.26} Sample Size for Given Length – Hogg 4.2.15}\label{exr:4.2.26}
...
\begin{exercise}{\ref{exr:4.2.27} Binomial Sample Size – Hogg 4.2.16}\label{exr:4.2.27}
...
\begin{exercise}{\ref{exr:4.2.28} Poisson Confidence Interval – Hogg 4.2.17}\label{exr:4.2.28}
...
\begin{exercise}{\ref{exr:4.2.29} Variance CI via Chi-square – Hogg 4.2.19}\label{exr:4.2.29}
...
\begin{exercise}{\ref{exr:4.2.30} Exact Gamma CI – Hogg 4.2.20}\label{exr:4.2.30}
...
\begin{exercise}{\ref{exr:4.2.31} Tack Point-Up – Hogg 4.2.21}\label{exr:4.2.31}
...
\begin{exercise}{\ref{exr:4.2.32} Two-Sample Normal CI – Hogg 4.2.22}\label{exr:4.2.32}
...
\begin{exercise}{\ref{exr:4.2.33} Binomial Proportion Diff – Hogg 4.2.23}\label{exr:4.2.33}
...
\begin{exercise}{\ref{exr:4.2.34} Known Variance Diff – Hogg 4.2.24}\label{exr:4.2.34}
...
\begin{exercise}{\ref{exr:4.2.35} Unknown Unequal Variance – Hogg 4.2.25}\label{exr:4.2.35}
...
\begin{exercise}{\ref{exr:4.2.36} Ratio Known Variance – Hogg 4.2.26}\label{exr:4.2.36}
...
\begin{exercise}{\ref{exr:4.2.37} Sample Size for Mean Diff – Hogg 4.2.27}\label{exr:4.2.37}
...
\begin{exercise}{\ref{exr:4.2.38} Variance Ratio CI – Hogg 4.2.27}\label{exr:4.2.38}
...
\begin{exercise}{\ref{exr:4.2.39} Exact Binomial CI – Hogg 4.3.1}\label{exr:4.2.39}
Recall for the baseball data, 15 out of 59 ballplayers are left-handed. Determine an exact $90\%$ confidence interval for $p$.
\end{exercise}

\begin{exercise}{\ref{exr:4.2.40} Asymptotic CI Verification – Hogg 4.3.2}\label{exr:4.2.40}
In Example 4.3.2, verify the result for the asymptotic confidence interval for $\theta$.
\end{exercise}

\begin{exercise}{\ref{exr:4.4.1} Discrete Exact Tack CI – Hogg 4.3.3}\label{exr:4.4.1}
In Exercise 4.2.20, find the discrete exact confidence interval for the proportion.
\end{exercise}

\begin{exercise}{\ref{exr:4.4.2} Poisson Exact CI – Hogg 4.3.4}\label{exr:4.4.2}
...
\begin{exercise}{\ref{exr:4.4.3} t-Interval Derivation – Hogg 4.3.5}\label{exr:4.4.3}
...
\begin{exercise}{\ref{exr:4.4.4} Beta Integral Identity – Hogg 4.3.6}\label{exr:4.4.4}
...
\begin{exercise}{\ref{exr:4.4.5} Poisson CDF Identity – Hogg 4.3.7}\label{exr:4.4.5}
...
\begin{exercise}{\ref{exr:4.4.6} Distribution Quantiles – Hogg 4.4.1}\label{exr:4.4.6}
Obtain closed-form expressions for the distribution quantiles based on the exponential and Laplace distributions.
\end{exercise}

\begin{exercise}{\ref{exr:4.4.7} Potential Outlier Probability – Hogg 4.4.2}\label{exr:4.4.7}
...
\begin{exercise}{\ref{exr:4.4.8} Data Summary and Outliers – Hogg 4.4.3}\label{exr:4.4.8}
...
\begin{exercise}{\ref{exr:4.4.9} Normal Q-Q Plot – Hogg 4.4.4}\label{exr:4.4.9}
...
\begin{exercise}{\ref{exr:4.4.10} Exponential Order Statistic – Hogg 4.4.5}\label{exr:4.4.10}
...
\begin{exercise}{\ref{exr:4.4.11} Continuous Distribution Order Stats – Hogg 4.4.6}\label{exr:4.4.11}
...
\begin{exercise}{\ref{exr:4.4.12} Discrete Order Statistic PMF – Hogg 4.4.7}\label{exr:4.4.12}
...
\begin{exercise}{\ref{exr:4.4.13} Independent Transformations – Hogg 4.4.8}\label{exr:4.4.13}
...
\begin{exercise}{\ref{exr:4.4.14} Beta Distribution of Order Statistic}\label{exr:4.4.14}
...
\begin{exercise}{\ref{exr:4.4.18} Ratio of Observations}\label{exr:4.4.18}
...
\begin{exercise}{\ref{exr:4.4.19} Midrange Distribution}\label{exr:4.4.19}
Let $Y_1 < Y_2 < Y_3$ denote order statistics from uniform(0,1). Let $Z=(Y_1+Y_3)/2$ be the midrange. Find the pdf of $Z$.
\end{exercise}

\begin{exercise}{\ref{exr:4.4.20} Normal Order Stats Expectation}\label{exr:4.4.20}
...
\begin{exercise}{\ref{exr:4.4.21} Independence Characterizes Exponential}\label{exr:4.4.21}
...
\begin{exercise}{\ref{exr:4.4.22} Conditional Distribution}\label{exr:4.4.22}
...
\begin{exercise}{\ref{exr:4.4.23} Triangle Probability}\label{exr:4.4.23}
...
\begin{exercise}{\ref{exr:4.4.27} Exponential Order Stats Properties}\label{exr:4.4.27}
...
\begin{exercise}{\ref{exr:4.4.28} PERT Distribution}\label{exr:4.4.28}
...
\begin{exercise}{\ref{exr:4.4.29} Sample Size for Extreme Quantile}\label{exr:4.4.29}
Let $Y_n$ denote the $n$th order statistic. Find the smallest $n$ for which $P(\xi_{0.9} < Y_n) \geq 0.75$.
\end{exercise}

\begin{exercise}{\ref{exr:4.4.30} Probability Involving Quantiles}\label{exr:4.4.30}
...
\begin{exercise}{\ref{exr:4.4.31} Median Between Order Stats}\label{exr:4.4.31}
Compute $P(Y_3 < \xi_{0.5} < Y_7)$ if $Y_1 < \ldots < Y_9$ are order statistics of size 9.
\end{exercise}

\begin{exercise}{\ref{exr:4.4.32} Sample Size for Median Coverage}\label{exr:4.4.32}
Find the smallest $n$ for which $P(Y_1 < \xi_{0.5} < Y_n) \geq 0.99$.
\end{exercise}

\begin{exercise}{\ref{exr:4.4.33} Normal Order Stats Interval}\label{exr:4.4.33}
...
\begin{exercise}{\ref{exr:4.4.34} Selection Algorithm}\label{exr:4.4.34}
...
\begin{exercise}{\ref{exr:4.4.35} Motor Median CI}\label{exr:4.4.35}
Refer to Exercise 4.1.1. Using expression (4.4.10), obtain a confidence interval for the median lifetime of a motor.
\end{exercise}

\begin{exercise}{\ref{exr:4.5.1} Power Function of Test}\label{exr:4.5.1}
...
\begin{exercise}{\ref{exr:4.5.2} Darwin Data t-Test}\label{exr:4.5.2}
For the Darwin data, verify that the Student $t$-test statistic is 2.15.
\end{exercise}

\begin{exercise}{\ref{exr:4.5.3} Neyman-Pearson Test}\label{exr:4.5.3}
...
\begin{exercise}{\ref{exr:4.5.4} Binomial Significance Level}\label{exr:4.5.4}
...
\begin{exercise}{\ref{exr:4.5.5} Exponential LR Test}\label{exr:4.5.5}
...
\begin{exercise}{\ref{exr:4.5.6} Power Curve Sketch}\label{exr:4.5.6}
...
\begin{exercise}{\ref{exr:4.5.7} Tire Life Test}\label{exr:4.5.7}
...
\begin{exercise}{\ref{exr:4.5.8} Poisson Power Function}\label{exr:4.5.8}
...
\begin{exercise}{\ref{exr:4.5.9} Binomial Sample Size}\label{exr:4.5.9}
Let $Y \sim \text{binomial}(n,p)$. Test $H_0: p=1/2$ vs $H_1: p>1/2$. Find $n$ and $c$ so that $\gamma(1/2)=0.10$ and $\gamma(2/3)=0.95$.
\end{exercise}

\begin{exercise}{\ref{exr:4.5.10} Uniform Max Test}\label{exr:4.5.10}
...
\begin{exercise}{\ref{exr:4.5.11} Poisson Test Size}\label{exr:4.5.11}
...
\begin{exercise}{\ref{exr:4.5.12} Tennis Serve Hypothesis}\label{exr:4.5.12}
...
\begin{exercise}{\ref{exr:4.5.13} Bernoulli Power Comparison}\label{exr:4.5.13}
...
\begin{exercise}{\ref{exr:4.6.3} Paired Design Analysis}\label{exr:4.6.3}
...
\begin{exercise}{\ref{exr:4.6.4} AZT Dosage Study}\label{exr:4.6.4}
...
\begin{exercise}{\ref{exr:4.6.5} Air Quality Comparison}\label{exr:4.6.5}
...
\begin{exercise}{\ref{exr:4.6.6} Seat Belt Campaign}\label{exr:4.6.6}
...
\begin{exercise}{\ref{exr:4.6.7} Variance Test Critical Value}\label{exr:4.6.7}
...
\begin{exercise}{\ref{exr:4.6.11} Normal Approximation Test}\label{exr:4.6.11}
...
\begin{exercise}{\ref{exr:4.6.12} Die Casting Test}\label{exr:4.6.12}
...
\begin{exercise}{\ref{exr:4.6.13} Mendelian Genetics}\label{exr:4.6.13}
...
\begin{exercise}{\ref{exr:4.6.14} Teaching Method Comparison}\label{exr:4.6.14}
Two groups of 100 students each. Test at $5\%$ whether the two distributions are the same.
\end{exercise}

\begin{exercise}{\ref{exr:4.6.15} Crime and Alcoholism}\label{exr:4.6.15}
...
\begin{exercise}{\ref{exr:4.6.16} Independence Test}\label{exr:4.6.16}
...
\begin{exercise}{\ref{exr:4.6.17} Poisson Goodness of Fit}\label{exr:4.6.17}
...
\begin{exercise}{\ref{exr:4.6.18} MCT Converse}\label{exr:4.6.18}
...
\begin{exercise}{\ref{exr:4.8.19} Bootstrap Sample Properties}\label{exr:4.8.19}
...
\begin{exercise}{\ref{exr:4.8.20} Gamma Bootstrap CI}\label{exr:4.8.20}
...
\begin{exercise}{\ref{exr:4.8.24} Bootstrap Median Test}\label{exr:4.8.24}
...
\begin{exercise}{\ref{exr:4.8.25} Two-Sample t-Test Value}\label{exr:4.8.25}
Consider data of Example 4.9.2. Show $t=0.93$ with $p$-value 0.18.
\end{exercise}

\begin{exercise}{\ref{exr:4.8.26} Bootstrap Two-Sided Test}\label{exr:4.8.26}
...
\begin{exercise}{\ref{exr:4.8.27} Permutation Test}\label{exr:4.8.27}
...
\begin{exercise}{\ref{exr:4.8.28} Bootstrap z Distribution}\label{exr:4.8.28}
Let $z^*$ be drawn from discrete distribution with mass $n^{-1}$ at $z_i = x_i - \overline{x} + \mu_0$. Determine $E(z^*)$ and $V(z^*)$.
\end{exercise}

\begin{exercise}{\ref{exr:4.8.29} Bootstrap t-Test Value}\label{exr:4.8.29}
For Example 4.9.3, show $t=0.84$ and $p$-value is 0.20.
\end{exercise}

\begin{exercise}{\ref{exr:4.8.30} Bootstrap Median Test}\label{exr:4.8.30}
For Example 4.9.3, obtain bootstrap test based on medians for $H_0: \mu=90$ vs $H_1: \mu>90$.
\end{exercise}

\begin{exercise}{\ref{exr:4.8.31} Darwin Experiment Bootstrap}\label{exr:4.8.31}
