...
\begin{Exercise}{7.2.1 — Sufficient Statistic for Normal Variance}
Let $X_{1}, X_{2}, \ldots, X_{n}$ be iid $N(0, \theta)$, $0 < \theta < \infty$. Show that $\sum_{i=1}^{n} X_{i}^{2}$ is a sufficient statistic for $\theta$.
\end{Exercise}

\begin{Exercise}{7.2.4 — Geometric Distribution Sufficiency}
...
\begin{Exercise}{7.3.3 — Rao-Blackwell for Exponential Distribution}
...
\begin{Exercise}{7.4.1 — Completeness of Binomial Family}
...
\begin{Exercise}{7.4.5 — Complete Sufficient Statistic for Shifted Exponential}
...
\begin{Exercise}{7.5.2 — MVUE via Exponential Class}
...
\begin{Exercise}{7.6.1 — MVUE of $\theta^{2}$ for Normal}
...
\begin{Exercise}{7.9.1 — Basu's Theorem for Uniform Distribution}
