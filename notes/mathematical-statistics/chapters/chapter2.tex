...
\begin remark}\label{rmk:pdf-greater-than-one}
...
\begin remark}\label{rmk:marginal-name}
...
\begin remark}\label{rmk:corr-vs-cov}
...
\begin remark}\label{rmk:bivariate-normal-conditional}
\textbf{条件分布的几何直觉}：在二元正态中，条件均值
\[
