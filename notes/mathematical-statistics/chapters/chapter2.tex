...
\textbf{注意}：在连续情形，$\mathbb{P}(X_1 = x_1) = 0$，所以不能直接用条件概率定义。这里用条件密度代替——条件密度的定义源自 Radon-Nikodym 定理，它是条件期望存在性的数学基础。\footnote{详细讨论见附录 \cref{sec:derivation-ch2-conditional-density}。}
