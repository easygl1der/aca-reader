...
\begin theorem}[FIXME][似然函数的渐近支撑]\label{th:likelihood-asymptotic}
...
\begin theorem}[FIXME][MLE 的相合性]\label{th:mle-consistency}
...
\begin theorem}[FIXME][Rao-Cramér 下界]\label{th:rao-cramer-bound}
...
\begin theorem}[FIXME][MLE 的渐近正态性和有效性]\label{th:mle-asymptotic}
...
\begin theorem}[FIXME][似然比检验的渐近分布]\label{th:lrt-asymptotic}
...
\begin theorem}[FIXME][多参数 MLE 的渐近分布]\label{th:multiparameter-mle-asymptotic}
...
\begin theorem}[FIXME][多参数似然比检验的渐近分布]\label{th:multiparameter-lrt}
...
\begin theorem}[FIXME][EM 算法的单调性]\label{th:em-monotonicity}
