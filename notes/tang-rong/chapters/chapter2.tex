...
\begin{Theorem}[Regime 1 的极小极大速率]\label[theorem]{thm:regime1}
...
\begin{Theorem}[Regime 2 的极小极大速率]\label[theorem]{thm:regime2}
...
\begin{enumerate}
    ...
    \item \textbf{联合估计 vs 独立估计}：
          ...
          （见\cref{eq:joint-mean-regression} 和\cref{fig:regime2-phase}）。
\end{enumerate}
...
\begin{Remark}\label[remark]{rem:intrinsic-vs-environmental}
