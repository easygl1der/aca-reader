...
% noteinfo: highlighted remark box
\newtheorem{noteinfoenv}{注}
\usepackage{mdframed}
\usepackage{tcolorbox}
\newtcolorbox{noteinfo}{colback=yellow!20, colframe=yellow!60!black,
  boxrule=0.5pt, left=5pt, right=5pt, top=5pt, bottom=5pt}
