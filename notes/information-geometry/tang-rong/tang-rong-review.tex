...
\[
\text{\citep{tang2022minimax} 极小极大理论}
\;\xrightarrow{\;\text{具体化}\;}\;
\text{\citep{tang2023lowdim} MLDMAE 方法}
\;\xrightarrow{\;\text{推广}\;}\;
\text{\citep{tang2025regression} 分布回归框架}
\]
...
\text{\citep{tang2024diffusion} 扩散模型自适应流形}
\;\xrightarrow{\;\text{推广到条件设定}\;}\;
\text{\citep{tang2025conditional} 条件扩散模型最优性}
\]
...
\[
\text{\citep{tang2023robust} 流形 BvM + RRWM}
\;\xrightarrow{\;\text{利用 BvM 性质}\;}\;
\text{\citep{tang2024mala} MALA 最优混合时间}
\]
